...
namespace QLDSV.Fe.Reports.SVDK
{
    public partial class SVDKReport : Form
    {
        ...
        public SVDKReport(string tenKhoa, string nienKhoa, string hocKy, string maMH, string tenMH, string nhom)
        {
            InitializeComponent();
            _tenKhoa = tenKhoa;
            _nienkhoa = nienKhoa;
        ...
        private void SVDKReport_Load(object sender, EventArgs e)
        {
            LoadReport();
        }
        ...
        {
            return Path.Combine(AppDomain.CurrentDomain.BaseDirectory, @"Fe\Reports\SVDK\SVDK.rdlc");
        }
