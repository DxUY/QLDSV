...
{
    public partial class sBDLTC : Form
    {
        private readonly string _khoa;

        public sBDLTC(string khoa)
        {
            InitializeComponent();
            _khoa = khoa;
        }
        ...
        private void search_Click(object sender, EventArgs e)
        {
            ...
            if (Validation.IsInputComplete(inputs))
            {
                ...
                var reportForm = new BDLTCReport(_khoa, inputs["nienKhoa"], inputs["hocKy"], maMH, inputs["monHoc"], inputs["nhom"]);
